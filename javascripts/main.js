...
function properValue(a){
 ...
 document.getElementById("demo").placeholder="Enter valid value";
...
function checkFunction()
{
 ...
 var gpa= document.getElementById("gpa").value;
   ...
   if (!egrade)
 {
      document.getElementById("egrade").placeholder="Fill your english grade"
     ...
     if(mgrade == "A+" || mgrade == "A" || mgrade == "B+" || mgrade =="B" || mgrade =="C+" || mgrade=="C" || mgrade=="D+" )
     {
       if(scigrade == "A+" || scigrade == "A" || scigrade == "B+" || scigrade =="B" || scigrade =="C+" || scigrade=="C" || scigrade=="D+" )
       {
         if(socgrade == "A+" || socgrade == "A" || socgrade == "B+" || socgrade =="B" || socgrade =="C+" || socgrade=="C" || socgrade=="D+"  )
         {
           if (gpa >=1.6)
           {
             document.getElementById("demo").style="background-color: light-green;";
             //document.getElementById("demo").class="bg-success"
